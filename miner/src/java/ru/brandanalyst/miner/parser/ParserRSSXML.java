...
public class ParserRSSXML {
    ...
    private Timestamp evalTimestamp(String stringDate) throws StringIndexOutOfBoundsException {
        ...
        {
            case "Jan":resultDate.append("01");
            break;
            case "Feb":resultDate.append("02");
            break;
            case "Mar":resultDate.append("03");
            break;
            case "Apr":resultDate.append("04");
            break;
            case "May":resultDate.append("05");
            break;
            case "Jun":resultDate.append("06");
            break;
            case "Jul":resultDate.append("07");
            break;
            case "Aug":resultDate.append("08");
            break;
            case "Sep":resultDate.append("09");
            break;
            case "Oct":resultDate.append("10");
            break;
            case "Nov":resultDate.append("11");
            break;
            case "Dec":resultDate.append("12");
            break;
        }
        resultDate.append(dateTokenizer.nextToken());

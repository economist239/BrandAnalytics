...
public class InMemoryBrandProvider implements BrandProvider {
    ...
    {
        depot.add(new Brand(1, "1", "1", "1", 1, Params.empty()));
        depot.add(new Brand(2, "2", "2", "2", 2, Params.empty()));
        depot.add(new Brand(3, "3", "3", "3", 1, Params.empty()));
        depot.add(new Brand(4, "4", "4", "4", 2, Params.empty()));
        depot.add(new Brand(5, "5", "5", "5", 1, Params.empty()));
        key = 5;
